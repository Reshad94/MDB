...
//-------------------------- 
    ...
    mon_a_f_year = new Array(mon_n_f.length), mon_a_f_quorter = new Array(mon_n_f.length), mon_a_f_month = new Array(mon_n_f.length), mon_a_f_dpart = new Array(mon_n_f.length);
...
mon_a_f_year[mon_n_f.indexOf(ent[e].field("Account") + "   ==>   " + ent[e].field("_Account"))]
    ...
    f.writeLine("id = " + ent[e].field("ID") + " " + ent[e].field("Account") + "   ==>   " + ent[e].field("_Account") + " " + 
         ...
         " mon_n.index: " +  mon_n_f.indexOf(ent[e].field("Account") + "   ==>   " + ent[e].field("_Account")) +
